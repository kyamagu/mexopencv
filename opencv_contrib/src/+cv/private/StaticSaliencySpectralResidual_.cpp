/**
 * @file StaticSaliencySpectralResidual_.cpp
 * @brief mex interface for cv::saliency::StaticSaliencySpectralResidual
 * @ingroup saliency
 * @author Amro
 * @date 2016
 */
...
int last_id = 0;
/// Object container
map<int,Ptr<StaticSaliencySpectralResidual> > obj_;
}
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    Ptr<StaticSaliencySpectralResidual> obj = obj_[id];
    if (obj.empty())
