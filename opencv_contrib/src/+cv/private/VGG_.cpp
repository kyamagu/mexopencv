/**
 * @file VGG_.cpp
 * @brief mex interface for cv::xfeatures2d::VGG
 * @ingroup xfeatures2d
 * @author Amro
 * @date 2017
 */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (method == "new") {
        ...
        obj_[++last_id] = createVGG(rhs.begin() + 2, rhs.end());
    ...
    if (method == "delete") {
        ...
        obj_[id] = (loadFromString ?
            Algorithm::loadFromString<VGG>(rhs[2].toString(), objname) :
            Algorithm::load<VGG>(rhs[2].toString(), objname));
    }
    else if (method == "save") {
