 ...
 * @brief mex interface for cv::xphoto::GrayworldWB
 * @ingroup xphoto
 * @author Amro
 * @date 2017
 */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (method == "new") {
        nargchk(nrhs==2 && nlhs<=1);
        obj_[++last_id] = createGrayworldWB();
    ...
    if (method == "delete") {
        ...
        obj_[id] = (loadFromString ?
            Algorithm::loadFromString<GrayworldWB>(rhs[2].toString(), objname) :
            Algorithm::load<GrayworldWB>(rhs[2].toString(), objname));
        */
        ///*
        // HACK: workaround for missing GrayworldWB::create()
