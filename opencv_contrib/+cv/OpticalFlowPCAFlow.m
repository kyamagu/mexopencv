classdef OpticalFlowPCAFlow < handle
    ...
    methods
        function this = OpticalFlowPCAFlow()
            ...
            %       path to prior. This instantiates a class used for imposing
            %       a learned prior on the resulting optical flow. Solution
            %       will be regularized according to this prior. You need to
            %       generate appropriate prior file with "learn_prior.py"
            %       script beforehand.
            ...
            %       least-squares. It is not related to the prior
            %       regularization. default 0.00002
