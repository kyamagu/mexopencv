classdef AffineFeature2D < handle
    ...
    methods
        ...
        function [descriptors, keypoints] = compute(this, img, keypoints)
            ...
            %       Sometimes new keypoints can be added, for example: cv.AffineFeature2D
        ...
        function [keypoints, descriptors] = detectAndCompute(this, img, varargin)
            ...
            %       vector, as returned by cv.AffineFeature2D.descriptorSize,
    ...
    methods
        ...
        function [keypoints, descriptors] = detectAndCompute_elliptic(this, img, varargin)
            ...
            %             `[ax1,ax2]`
            %       * __si__ the integration scale at which the parameters
            %             were estimated.
            %       * __transf__ the transformation between image space and
            %             local patch space, 2x3 matrix.
