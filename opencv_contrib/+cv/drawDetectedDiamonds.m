...
%       returned by cv.detectCharucoDiamond. (e.g `{{[x y],..}, ..}`). The
...
%       in the same format returned by cv.detectCharucoDiamond (e.g. cell
%       array of 4-integer vectors). Optional, if not provided, ids are
%       not painted.
% * __BorderColor__ color of marker borders. Rest of colors (text color and
%       first corner color) are calculated based on this one.
%       Default [0,0,255].
%
