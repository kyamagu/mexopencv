classdef DAISY < handle
    ...
    methods
        function this = DAISY(varargin)
            ...
            %             equal to 1.0 but no individual one is bigger than
            %             0.154 as in SIFT
    ...
    methods
        ...
        function [descriptors, keypoints] = compute(this, image, keypoints)
            ...
            % See also: cv.DAISY.DAISY
            %
            [descriptors, keypoints] = DAISY_(this.id, 'compute', image, keypoints);
        end
        ...
        function descriptors = compute_all(this, image, varargin)
            ...
            %
            % ## Output
            % * __descriptors__ In the first form, resulted descriptors array
