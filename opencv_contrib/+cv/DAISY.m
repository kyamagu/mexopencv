classdef DAISY < handle
    ...
    methods
        function this = DAISY(varargin)
            ...
            %   * __Full__ mean that descriptors are normalized for L2 norm
            %     equal to 1.0
            %   * __SIFT__ mean that descriptors are normalized for L2 norm
    ...
    methods
        ...
        function [descriptors, keypoints] = compute(this, img, keypoints)
            ...
            %   image is internally converted to 32-bit floating-point in [0,1]
            %   range.
    ...
    methods
        ...
        function descriptor = GetDescriptor(this, y, x, orientation, varargin)
            ...
            %
            % ## Options
            % * __H__ optional 3x3 homography matrix for warped grid. Not set
            %   by default
