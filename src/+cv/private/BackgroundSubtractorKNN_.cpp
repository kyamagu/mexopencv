                  ...
                  int nrhs, const mxArray *prhs[] )
{
    ...
    if (method == "delete") {
        ...
        Ptr<BackgroundSubtractorKNN> obj2;
        /*
        if (loadFromString)
            obj2 = Algorithm::loadFromString<BackgroundSubtractorKNN>(s, objname);
        else
            obj2 = Algorithm::load<BackgroundSubtractorKNN>(s, objname);
        */
        ///*
        ...
        obj2 = createBackgroundSubtractorKNN();
        obj2->read(fn);
        //*/
        if (obj2.empty())
