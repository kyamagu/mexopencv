/**
 * @file TonemapDrago_.cpp
 * @brief mex interface for cv::TonemapDrago
 * @ingroup photo
 * @author Amro
 * @date 2015
 */
 ...
 * @return smart pointer to created TonemapDrago
 */
Ptr<TonemapDrago> create_TonemapDrago(
    ...
    vector<MxArray>::const_iterator last)
{
    ...
    return createTonemapDrago(gamma, saturation, bias);
}
}
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (method == "new") {
        nargchk(nrhs>=2 && nlhs<=1);
        obj_[++last_id] = create_TonemapDrago(
            rhs.begin() + 2, rhs.end());
    ...
    if (method == "delete") {
        ...
        obj_[id] = (loadFromString ?
            Algorithm::loadFromString<TonemapDrago>(rhs[2].toString(), objname) :
            Algorithm::load<TonemapDrago>(rhs[2].toString(), objname));
        */
        ///*
        // HACK: workaround for missing TonemapDrago::create()
