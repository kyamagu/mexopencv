...
%   chooses an appropriate type depending on the direction of conversion. So
%   if `map1` is in fixed-point representation, the output type is `single2`
%   (for combined floating-point representation), otherwise if `map1` is in
%   floating-point representation, the output type is `int16` (for fixed-point
