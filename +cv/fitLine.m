...
%
% ## Input
% * __points__ Input vector of 2D or 3D points. 2D points stored in a cell
%   array of 2-element vectors in the form `{[x,y], [x,y], ...}` or a
%   Nx2/Nx1x2/1xNx2 numeric array. 3D points stored in a cell array of
%   3-element vectors in the form `{[x,y,z], [x,y,z], ...}` or a
%   Nx3/Nx1x3/1xNx3 numeric array.
%
% ## Output
% * __lin__ Output line parameters. In case of 2D fitting, it is a vector of
%   4-elements vector `[vx,vy, x0,y0]`, where `[vx,vy]` is a normalized vector
%   collinear to the line and `[x0,y0]` is a point on the line. In case of 3D
%   fitting, it is a 6-elements vector `[vx,vy,vz, x0,y0,z0]`, where
%   `[vx,vy,vz]` is a normalized vector collinear to the line and `[x0,y0,z0]`
