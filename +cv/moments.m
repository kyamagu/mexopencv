...
%   or a cell array of 2D points (of `int32` or `single` type) of the form
%   `{[x,y], ...}`.
%
% ## Output
% * __mo__ Output moments. A structure with the following fields:
%   * Spatial moments: __m00__, __m10__, __m01__, __m20__, __m11__, __m02__,
%     __m30__, __m21__, __m12__, __m03__
...
% [Green's formula](https://en.wikipedia.org/wiki/Green_theorem). So, due to
