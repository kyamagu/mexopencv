...
% Output:
%     corners: Output refined coordinates.
% Options:
%     'WinSize': Half of the side length of the search window. For example, if
%         winSize=Size(3,3), then a 3 * 2 + 1 x 3 * 2 + 1 = 7 x 7 search window
%         is used. default [3, 3].
%     'ZeroZone':  Half of the size of the dead region in the middle of the
