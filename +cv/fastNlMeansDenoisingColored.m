...
%   `H` value perfectly removes noise but also removes image details, smaller
...
%   `src` and output `dst`, between MATLAB's RGB/RGBA order and OpenCV's
%   BGR/BGRA (input: RGB/RGBA->BGR/BGRA, output: BGR/BGRA->RGB/RGBA).
%   default false
%
