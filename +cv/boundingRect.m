...
%
% ## Input
% * __points__ Input 2D point set, stored in numeric array (Nx2/Nx1x2/1xNx2)
%   or cell array of 2-element vectors (`{[x,y], ...}`). Supports integer
%   (`int32`) and floating-point (`single`) classes.
