...
%   * __HitMiss__ "hit or miss". Only supported for `uint8` 1-channel binary
...
%   cv.getStructuringElement. Empty by default, which uses a 3x3 rectangular
%   structuring element by default.
