classdef NormalBayesClassifier < handle
    ...
    methods
        ...
        function status = train(this, samples, responses, varargin)
            ...
            %   from scratch (`UpdateModel=false`), or should be updated using
            %   the new training data (`UpdateModel=true`) instead of being
    ...
    methods
        function [outputs,outputProbs,f] = predictProb(this, inputs, varargin)
            ...
            %   `nsamples-by-nclasses`). The probabilities are not normalized
            %   to the 0..1 range.
            % * __f__ unused and returns 0.
            %
            % ## Options
