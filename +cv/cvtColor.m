...
%   floating-point.
% * __code__ Color space conversion code string, e.g., 'RGB2GRAY'. The
%   following codes are supported:
%   * __BGR2BGRA__, __RGB2RGBA__: add alpha channel to RGB and BGR image
%   * __BGRA2BGR__, __RGBA2RGB__: remove alpha channel from RGB and BGR image
%   * __BGR2RGBA__, __RGB2BGRA__, __RGBA2BGR__, __BGRA2RGB__, __BGR2RGB__,
%     __RGB2BGR__, __BGRA2RGBA__, __RGBA2BGRA__: convert between RGB and BGR
%     color spaces (with or without alpha channel)
%   * __BGR2GRAY__, __RGB2GRAY__, __GRAY2BGR__, __GRAY2RGB__, __GRAY2BGRA__,
%     __GRAY2RGBA__, __BGRA2GRAY__, __RGBA2GRAY__: convert between RGB/BGR and
%     grayscale
...
%   * __GRAY2BGR565__, __BGR5652GRAY__: convert between grayscale and BGR565
%     (16-bit images)
...
%   * __GRAY2BGR555__, __BGR5552GRAY__: convert between grayscale and BGR555
%     (16-bit images)
...
%     __LRGB2Lab__, __Lab2LBGR__, __Lab2LRGB__: convert between RGB/BGR and
%     CIE Lab
%   * __BGR2Luv__, __RGB2Luv__, __Luv2BGR__, __Luv2RGB__, __LBGR2Luv__,
%     __LRGB2Luv__, __Luv2LBGR__, __Luv2LRGB__: convert between RGB/BGR and
%     CIE Luv
%   * **YUV2RGB_NV12**, **YUV2BGR_NV12**, **YUV2RGB_NV21**, **YUV2BGR_NV21**,
%     __YUV420sp2RGB__, __YUV420sp2BGR__, **YUV2RGBA_NV12**, **YUV2BGRA_NV12**,
%     **YUV2RGBA_NV21**, **YUV2BGRA_NV21**, __YUV420sp2RGBA__,
%     __YUV420sp2BGRA__, **YUV2RGB_YV12**, **YUV2BGR_YV12**, **YUV2RGB_IYUV**,
%     **YUV2BGR_IYUV**, **YUV2RGB_I420**, **YUV2BGR_I420**, __YUV420p2RGB__,
%     __YUV420p2BGR__, **YUV2RGBA_YV12**, **YUV2BGRA_YV12**, **YUV2RGBA_IYUV**,
%     **YUV2BGRA_IYUV**, **YUV2RGBA_I420**, **YUV2BGRA_I420**,
%     __YUV420p2RGBA__, __YUV420p2BGRA__, **YUV2GRAY_420**, **YUV2GRAY_NV21**,
%     **YUV2GRAY_NV12**, **YUV2GRAY_YV12**, **YUV2GRAY_IYUV**,
%     **YUV2GRAY_I420**, __YUV420sp2GRAY__, __YUV420p2GRAY__: YUV 4:2:0 family
%     to RGB
%   * **YUV2RGB_UYVY**, **YUV2BGR_UYVY**, **YUV2RGB_Y422**, **YUV2BGR_Y422**,
%     **YUV2RGB_UYNV**, **YUV2BGR_UYNV**, **YUV2RGBA_UYVY**,
%     **YUV2BGRA_UYVY**, **YUV2RGBA_Y422**, **YUV2BGRA_Y422**,
%     **YUV2RGBA_UYNV**, **YUV2BGRA_UYNV**, **YUV2RGB_YUY2**, **YUV2BGR_YUY2**,
%     **YUV2RGB_YVYU**, **YUV2BGR_YVYU**, **YUV2RGB_YUYV**, **YUV2BGR_YUYV**,
%     **YUV2RGB_YUNV**, **YUV2BGR_YUNV**, **YUV2RGBA_YUY2**, **YUV2BGRA_YUY2**,
%     **YUV2RGBA_YVYU**, **YUV2BGRA_YVYU**, **YUV2RGBA_YUYV**,
%     **YUV2BGRA_YUYV**, **YUV2RGBA_YUNV**, **YUV2BGRA_YUNV**,
%     **YUV2GRAY_UYVY**, **YUV2GRAY_YUY2**, **YUV2GRAY_Y422**,
%     **YUV2GRAY_UYNV**, **YUV2GRAY_YVYU**, **YUV2GRAY_YUYV**,
%     **YUV2GRAY_YUNV**: YUV 4:2:2 family to RGB
%   * __RGBA2mRGBA__, __mRGBA2RGBA__: alpha premultiplication
%   * **RGB2YUV_I420**, **BGR2YUV_I420**, **RGB2YUV_IYUV**, **BGR2YUV_IYUV**,
%     **RGBA2YUV_I420**, **BGRA2YUV_I420**, **RGBA2YUV_IYUV**,
%     **BGRA2YUV_IYUV**, **RGB2YUV_YV12**, **BGR2YUV_YV12**, **RGBA2YUV_YV12**,
%     **BGRA2YUV_YV12**: RGB to YUV 4:2:0 family
...
%     __BayerBG2GRAY__, __BayerGB2GRAY__, __BayerRG2GRAY__, __BayerGR2GRAY__,
%     __BayerBG2BGRA__, __BayerGB2BGRA__, __BayerRG2BGRA__, __BayerGR2BGRA__,
%     __BayerBG2RGBA__, __BayerGB2RGBA__, __BayerRG2RGBA__, __BayerGR2RGBA__:
%     Demosaicing
%   * **BayerBG2BGR_VNG**, **BayerGB2BGR_VNG**, **BayerRG2BGR_VNG**,
%     **BayerGR2BGR_VNG**, **BayerBG2RGB_VNG**, **BayerGB2RGB_VNG**,
%     **BayerRG2RGB_VNG**, **BayerGR2RGB_VNG**: Demosaicing using Variable
%     Number of Gradients
...
%   0, the number of the channels is derived automatically from `src` and
%   `code`.
%
