...
%
% ## Output
% * __dst__ output array that has the same size and number of channels as
%       the input arrays.
%
% ## Options
% * __DType__ optional depth of the output array: `uint8`, `int16`, `double`,
%       etc. Must be specified if input arrays are of different types. When
%       both input arrays have the same depth, `DType` can be set to -1, which
%       will be equivalent to `class(src1)`. default -1
%
