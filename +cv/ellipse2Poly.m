...
% * __axes__ Half of the size of the ellipse main axes `[a,b]`. See the
%       cv.ellipse for details.
%
% ## Output
% * __pts__ Output vector of polyline vertices.
%
% ## Options
% * __Angle__ Rotation angle of the ellipse in degrees. Half of the size of
%       the ellipse main axes. See the cv.ellipse for details. default 0.
