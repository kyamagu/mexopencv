classdef TwoPassStabilizer < handle
    ...
    methods
        function setMotionStabilizer(this, motionStabType, varargin)
            ...
            %   * __MotionStabilizationPipeline__ A pipeline composed of other
            %     motion stabilizers, applied in sequence.
            %   * __GaussianMotionFilter__
            %   * __LpMotionStabilizer__ Note: To be able to use this method
            %     you must build OpenCV with CLP library support.
            %
            % ## Options
            % The following are options for the various algorithms:
            %
