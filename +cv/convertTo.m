...
%       or rather the depth since the number of channels are the same as the
%       input has; if it is negative, the output matrix will have the same
%       type as the input. Default -1
