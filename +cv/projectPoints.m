...
%
% Input:
%    objectPoints: Array of object points, Nx1x3/1xNx3 array or cell array
%        of 3-element vectors, where N is the number of points in the view.
%    rvec: Rotation vector. See cv.Rodrigues for details.
%    tvec: Translation vector.
%    cameraMatrix: Camera matrix A = [fx,0,cx;0,fy,cy;0,0,1].
...
% Output:
%    imagePoints: Output array of image points, Nx1x2/1xNx2 array or cell
%        array of 2-element vectors
%    jacobian: Optional output 2Nx(10+<numDistCoeffs>) jacobian matrix of
...
% Options:
%    'AspectRatio': Optional "fixed aspect ratio" parameter. If the
