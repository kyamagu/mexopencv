...
%   (1-channels), or `single` (2-channels). See cv.convertMaps for details on
...
%   `uint16` (1-channel) or `single` (1-channel), or none (empty map if `map1`
...
%   row/column size of `map1` and the type of `src`, otherwise it is ignored
