...
%   3-channel or 4-channel images sequence. All images should have the same
%   type and size.
...
%   applied to all channels or one value per channel in `dst`. Big `H` value
%   perfectly removes noise but also removes image details, smaller `H` value
%   preserves details but also preserves some noise. default [3]
% * __TemplateWindowSize__ Size in pixels of the template patch that is used
%   to compute weights. Should be odd. Recommended value 7 pixels. default 7
