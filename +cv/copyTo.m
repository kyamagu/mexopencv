...
% * __Mask__ Optional operation mask. Its non-zero elements indicate which
%       matrix elements need to be copied. The mask has to be of type `uint8`
%       or `logical` and can have 1 or multiple channels. Not set by default.
%
