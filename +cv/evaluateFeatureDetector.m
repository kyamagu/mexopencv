...
%   `{fdetector, 'key',val, ...}`, where the first element is the type, and
%   the remaining elements are optional parameters used to construct the
%   specified feature detector. See cv.FeatureDetector for possible types. Not
%   set by default (i.e: you must supply pre-detected keypoints in the inputs).
%
% ## Example
%
